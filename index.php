...
<body>
    ...
    <section class="seminar" id = "detail">
        ...
        <div class="tabs">
            ...
            <div class="tab_content" id="training_content">
              <div class="tab_content_description">
                ...
                <p class="c-txtsp">
                社会人の心構えやビジネスマナーが定着！<br>
                研修を受けることで社会人としての自覚が芽生え責任ある行動ができるようになります。
                ビジネスマナー研修は新入社員だけでなく、働く上で最も基本的な内容を社内で共有して新入社員を迎える準備にも役立ちます。
                </p>
              </div>
        </div>
        <div class="tab_content" id="smile_content">
          <div class="tab_content_description">
          <img src="img/slide_img4.JPG" alt="スマイル" />
            <p class="c-txtsp">
            第一印象は一度きり！<br>
            印象の良い笑顔のやり方を知って、会って0.5秒でステキと思われたくないですか？
            どんな時でもできるように自分の顔のクセを発見して、一緒にトレーニングを積み重ねて改善しましょう。<br>
            自分が笑っていると相手も笑ってくれます。
            </p>
          </div>
        </div>
        <div class="tab_content" id="hospitality_content">
          <div class="tab_content_description">
            <img src="img/slide_img2.jpg" alt="ホスピタリティ">

            <p class="c-txtsp">
            顧客満足度向上には従業員満足を上げる！<br>
            従業員さんが安心して楽しく働いているとそれが自然にお客様に伝わります。<br>
            「隣の人が今よりもちょっと良い状況になる」その考え方と行動の仕方を実践を交えながらレクチャー。<br>
            まずは、いつも一緒にいる従業員さんへ実践できるように考え方と行動の仕方をレクチャーします。
            </p>
          </div>
        </div>
      </div>
